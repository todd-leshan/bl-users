		...
		<>
			<Container className="py-6 lg:py-10">
				...
				<div className="flex flex-row gap-4">
					<Button color="primary" onClick={reloadAllUsers}>
						Reload all users
					</Button>
					<Button
						color="custom"
						className="bg-theme-3 border-theme-3 hover:text-primary"
						onClick={removeAllUsersFromList}
					>
						Clear all users
					</Button>
				</div>
				{reloadNoti && <p className="mt-2 text-sm text-secondary">You need to clear all users first.</p>}
			</Container>
